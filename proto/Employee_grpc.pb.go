...
type EmployeeServiceClient interface {
	GetEmployee(ctx context.Context, in *ReadEmployeeRequest, opts ...grpc.CallOption) (*ReadEmployeeResponse, error)
}
...
func (c *employeeServiceClient) GetEmployee(ctx context.Context, in *ReadEmployeeRequest, opts ...grpc.CallOption) (*ReadEmployeeResponse, error) {
...
type EmployeeServiceServer interface {
	GetEmployee(context.Context, *ReadEmployeeRequest) (*ReadEmployeeResponse, error)
...
func (UnimplementedEmployeeServiceServer) GetEmployee(context.Context, *ReadEmployeeRequest) (*ReadEmployeeResponse, error) {
...
func _EmployeeService_GetEmployee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).GetEmployee(ctx, req.(*ReadEmployeeRequest))
	}
